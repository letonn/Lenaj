...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝐋𝐈𝐓𝐇𝐎𝐍 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝐋𝐈𝐓𝐇𝐎𝐍**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝐋𝐈𝐓𝐇𝐎𝐍**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝐋𝐈𝐓𝐇𝐎𝐍 - [𝘿𝙀𝙑](t.me/A1DIIU) 𓆪"
)
...
⫷ بوت ليثون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @A1DIIU - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @S_1_02 - تحياتي : 𝐋𝐄𝐀𝐃𝐄𝐑 𝐒𝐀𝐃𝐃𝐀𝐌 𝐇𝐔𝐒𝐒𝐄𝐈𝐍 ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين ليثون ⫸',
    '⫷ اكتمل تنزيل انلاين ليثون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت ليثون ⫸',
    '⫷ اكتمل بدء بوت ليثون ⫸'
]
